...
class CompetitionControllerTests(unittest.TestCase):
    ...
    def test_full_single_block_cycle_requires_three_stable_seconds(self):
        ...
        self.assertIn("building_1_layer_1", controller.occupied_slot_ids)
    ...
    def test_remaining_cargo_is_placed_before_returning_for_material(self):
        controller = CompetitionController(CompetitionRules())
        controller.phase = CompetitionPhase.VERIFY_STABILITY
        controller.match_started_s = 0.0
        ...
        self.assertEqual(decision.cargo_slot_id, "cargo_center")
    ...
    def test_roof_is_requested_after_two_orange_placements(self):
        controller = CompetitionController(CompetitionRules())
        controller.placed_colors = ["orange", "orange"]
        self.assertEqual(controller._choose_next_color(), "purple")
        controller.placed_colors.append("purple")
